...
echo "=== Vision Electronic Indexing Manual/Legacy Universal Setup ==="
echo ""
echo "This helper only installs dependencies and prints manual MCP config steps."
echo "For the recommended automated universal installer, use .universal/scripts/quick-install.sh."
echo ""
...
# 3. MCP config
echo "[3/3] Manual MCP configuration"
echo "To configure your agent, copy the appropriate config from .universal/configs/:"
echo ""
...
echo ""
echo "=== Manual/legacy setup complete ==="
